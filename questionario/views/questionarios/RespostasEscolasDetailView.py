...
from questionario.models import TipoQuestionario, ItemQuestionario, RespostasQuestionario
...
class RespostasEscolasDetailView(LoginRequiredMixin,BasePermissoesView,TemplateView):
    ...
    template_name = "questionario/questionarios/respostasEscolasDetail.html"
