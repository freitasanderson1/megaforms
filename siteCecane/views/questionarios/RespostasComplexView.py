...
from siteCecane.models import TipoQuestionario, ItemQuestionario, RespostasAlternativoQuestionario, QuemRespondeu
...
class RespostasComplexView(LoginRequiredMixin, BasePermissoesView, TemplateView):
    ...
    template_name = "siteCecane/questionarios/respostasComplexas.html"
