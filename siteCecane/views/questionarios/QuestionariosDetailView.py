...
from siteCecane.forms import QuestionarioForm
from siteCecane.models import TipoQuestionario, ItemQuestionario, RespostasQuestionario, QuemRespondeu
from AGF.models.Escola import Escola
from siteCecane.models.gestao.questionarios.RespostasAlternativoQuestionario import RespostasAlternativoQuestionario
...
class QuestionariosDetailView(BasePermissoesView, TemplateView):
    template_name = "siteCecane/questionarios/QuestionarioDetail.html"
        ...
        if request.method == 'POST':
            ...
            if tipoQuestionario.tipoDoQuestionario == 0:
                ...
                if tamRequest < tamQuestionario:
                    ...
                    return redirect('siteCecane:questionariosDetail', slug=kwargs["slug"])
