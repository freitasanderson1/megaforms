...
##############
from siteCecane.models import TipoQuestionario, ItemQuestionario, OpcoesItemQuestionario
from siteCecane.forms import ItemQuestionarioAdminForm
from siteCecane.admin import ItemQuestionarioAdmin
...
class ItemQuestionarioInline(admin.TabularInline):
    ...
    # template = "admin/siteCecane/itemquestionario_inline.html"
    extra = 1
